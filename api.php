...
if(isset($_GET['acc'])){
    if($_GET['acc']=='frm'){
        if(isset($_POST['nombre']) && isset($_POST['telefono']) && isset($_POST['email'])  && isset($_POST['mensaje'])){
            ...
            <p>Le recordamos que tambi&eacute;n tenemos a su disposici&oacute;n otros canales de comunicación como tel&eacute;fono, whatsapp, telegram y redes sociales. Podr&aacute;s encontrar todos nuestros canales en <a href='https://systems.zendha.net/contacto'>https://systems.zendha.net/contacto</a>.</p>
            ...
            <h2>Hola equipo,</h2>
            <p>Se ha recibido un nuevo mensaje desde el sitio web de Zendha systems, Aqu&iacute; los datos del mensaje:</p>
